...
public class TGV extends JFrame implements Listener, ActionListener, MouseListener {
    ...
    private void addViewerToPane(Container panel) {
        ...
        this.viewer = new VW(712, 712, this);
    ...
    void paint(int x, int y) {
        this.viewer.paint(x, y);
    }

    void delete(int x, int y) {
        this.viewer.delete(x,y);
    }
